      ...
      <center><h1>Donors Available </h1></center>
        <div id="table-container">
            ...
            <tr>
                ...
                <a href="http://localhost:8080/blood_donation/admin/delete.php?delete_id='.<?php echo $id; ?>.' " onclick="window.open('http://localhost:8080/blood_donation/admin/delete.php');">Delete</a></button>
                </td> 
            </tr>
            <?php
                }
