      ...
      <center><h1>Donors Available </h1></center>
        <div id="table-container">
            ...
            <tr>
                ...
                <a href="http://localhost:8080/blood_donation/admin/update.html" style="color:white;text-decoration:none;font-weight:300;">Update</a></button>
                <button class="Remove" id = "delete">
                <a style="color:white;text-decoration:none;font-weight:300;" href="http://localhost:8080/blood_donation/admin/delete.php?delete_id=<?php echo  $row['id_no']; ?> >Delete</a></button>
                </td> 
            </tr>
            <?php
                }
