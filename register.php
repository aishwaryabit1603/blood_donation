...
<div class="user">
    ...
    <form class="form" method = "post" action = "register.php" autocomplete="off">
        <div class="form__group">
          <input
            type="text"
            placeholder="Register As A Donor"
            class="form__input"
            disabled
            style="
              font-weight: 500;
        ...
        <div class="form__group">
          <input type="tel"  placeholder="Contact No" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form__input" name = "mobile_no" required/>
        </div>
        <div class="form__group">
            
        <div class="form__group">
          <input type="date" placeholder="Date Of Birth" name = "dob" class="form__input" required >
        </div>
        <div class="form__group">
      ...
      <div class="form__group">
        ...
        <div class="form__group">
          <input type="submit" value = "register" class="form__input" name = "register" required/>
        </div>
